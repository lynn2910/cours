...
> [!warning]
> Deux groupes possibles pour chaque sujet au plus (trinômes, voir binôme(s))

## Consignes

Deux documents à rendre
...
Résumer un ensemble d'informations pour une ou un responsable et/ou des collègues.
Cela permet d'éviter une lecture de documents prenant trop de temps.
...
Chaque document doit apporter une réponse partielle.
Le plan doit permettre d'y répondre.

La question est énoncée dans l'introduction, et la réponse en conclusion.

## Documents utiles à trouver
...
> [!warning] L'avis (partagé ou individuel si différents) doit être donné pour ce sujet
...
## Commenter les sources
 ...
 > [!tip] pour le [[#2ᵉ document sitographie commentée justifiant la pertinence des sources]]
...
- taille
- emplacement plus ou moins à droite
...
> [!warning] Attention aux malus importants
